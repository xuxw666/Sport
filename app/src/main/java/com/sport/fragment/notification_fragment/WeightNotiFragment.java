 ...
 */
public class WeightNotiFragment extends BaseNotiFragment {

    private View rootView;

    public View onCreateView(LayoutInflater layoutInflater,ViewGroup container,Bundle savedInstanceState){
        rootView = layoutInflater.inflate(R.layout.geren_noti_weight_fragment,container,false);

        setBackButton((TextView)rootView.findViewById(R.id.back_to_fragment));

        setDefault();

        LogUtil.debug(this.getClass(), "Weight fragment is created");
        return rootView;
    }
